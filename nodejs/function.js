...
let apply_numbers = [4, 100, 30, 33, 9, 2];
...
let apply_numbers2 = new Array("1", "2", "3");
...
let apply_student = new Apply_Student("zhangsan", 21, "一年级");
...
let apply_func = new function() {
  this.a = "apply_func";
}

let apply_myfunc = function(x, y) {
  let a = "apply_myfunc";
  console.log(this.a);
  console.log(x + y);
};

apply_myfunc.call(apply_func, "let", "fun"); // "func" "let fun"
apply_myfunc.apply(apply_func, ["let", "fun"]); // "func" "let fun"
//改变对象的this指向的内容
...
let anotherGuySayHello = bind_person.sayHello.bind({
  name: 'Alex',
...
myfunc.call(func, "let", "fun"); // "func" "let fun"
myfunc.apply(func, ["let", "fun"]); // "func" "let fun"
