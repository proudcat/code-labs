 ...
 class PocoJsonSerializerStrategy : IJsonSerializerStrategy
	{
		...
		{
			Console.WriteLine("ContructorDelegateFactory:" + key.ToString() + ",IsArray: " + key.IsArray);
 ...
 class ReflectionUtils
		{
			...
			{
				Console.WriteLine("GetConstructorInfo1111 : " + type.Name + "->" + argsType.Length);
				...
				foreach (ConstructorInfo constructorInfo in constructorInfos)
				{
					...
					{
						Console.WriteLine("GetConstructorInfo2222 : " + type.Name + "->" + parameterInfo.ParameterType.Name);
			...
			public static ConstructorDelegate GetConstructorByReflection(ConstructorInfo constructorInfo)
			{
				return delegate(object[] args)
				{
					...
					{
						sb.Append("<" + item.Name + ":" + item.ParameterType.Name + "> ");
					}
					Console.WriteLine("constructor invoked : " + pinfo.Length + "," + constructorInfo.Name + "," + sb.ToString());
			...
			public sealed class ThreadSafeDictionary<TKey, TValue> : IDictionary<TKey, TValue>
			{
				...
				public ThreadSafeDictionary(ThreadSafeDictionaryValueFactory<TKey, TValue> valueFactory)
				{
					...
					Console.WriteLine(typeof(TKey) + "<------->" + typeof(TValue));
				}
				...
				private TValue AddValue(TKey key)
				{
					...
					Console.WriteLine("AddValue:" + key.ToString() + ",value:" + value.ToString());
					lock (_lock)
					{
						if (_dictionary == null)
						{
